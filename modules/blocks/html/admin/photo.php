...
function update_block($url)
{
	...
	case 1:
		...
		if($model['photo']->$operation($_POST, 'where module="'.$_GET['module'].'" and idblock='.$_GET['IdBlocks']))
		{
			...
			die( redirect_webtsys(  set_admin_link( 'modify_blocks', array('IdModule' => $_GET['IdModule'], 'op' => 1, 'activation' => $_GET['activation'], 'language' =>  $_GET['language'], 'module' => $_GET['module']) ), $lang['common']['redirect'], $lang['common']['success'], $lang['common']['press_here_redirecting'] , $arr_block) );
