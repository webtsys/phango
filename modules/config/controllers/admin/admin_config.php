...
function ConfigAdmin()
{
	...
	$model['config_webtsys']->forms['portal_name']->SetForm($config_data_copy['portal_name']);
	$model['config_webtsys']->forms['portal_email']->SetForm($config_data_copy['portal_email']);

	$theme_check=$original_theme;
	
	if($config_data_copy['module_theme']!='')
	{
	
		$theme_check=basename($config_data_copy['module_theme']).'/'.$original_theme;
		
		$config_data_copy['dir_theme']=$theme_check;
	...
	$model['config_webtsys']->forms['x_avatar']->SetForm($config_data_copy['x_avatar']);
	$model['config_webtsys']->forms['y_avatar']->SetForm($config_data_copy['y_avatar']);
	$model['config_webtsys']->forms['date_format']->SetParameters( array( $config_data_copy['date_format'], $lang['config']['option_date_dmy'], 'd-m-Y', $lang['config']['option_date_ymd'], 'Y-m-d') );
	$model['config_webtsys']->forms['ampm']->SetParameters( array( $config_data_copy['ampm'], $lang['config']['ampm24'], 'H:i:s', $lang['config']['ampmAM'], 'h:i:s A') );
	$model['config_webtsys']->forms['accept_bbcode_signature']->SetParameters( array( $config_data_copy['accept_bbcode_signature'], $lang['common']['yes'], 0, $lang['common']['no'], 1) );
	$model['config_webtsys']->forms['name_guest']->SetForm($config_data_copy['name_guest']);
	$model['config_webtsys']->forms['active_users']->SetParameters( array( $config_data_copy['active_users'], $lang['common']['yes'], 1, $lang['common']['no'], 0) );

	$model['config_webtsys']->forms['metatags']->SetForm( $config_data_copy['metatags'] );
	
	$model['config_webtsys']->forms['meta_description']->SetForm( $config_data_copy['meta_description'] );

	$model['config_webtsys']->forms['meta_copyright']->SetForm( $config_data_copy['meta_copyright'] );

	$model['config_webtsys']->forms['meta_author']->SetForm( $config_data_copy['meta_copyright'] );

	$model['config_webtsys']->forms['foot']->SetForm( $config_data_copy['foot'] );

	$model['config_webtsys']->forms['cond_register']->SetForm( $config_data_copy['cond_register'] );

	$model['config_webtsys']->forms['wait_message']->SetForm( $config_data_copy['wait_message'] );

	$model['config_webtsys']->forms['ssl_feature']->SetForm( $config_data_copy['ssl_feature'] );

	//$model['config_webtsys']->forms['cookie_secure']->SetParameters( array( $config_data_copy['cookie_secure'], $lang['common']['yes'], 1, $lang['common']['no'], 0) );

	$model['config_webtsys']->forms['censoring']->SetParameters( array( $config_data_copy['censoring'], $lang['common']['yes'], 1, $lang['common']['no'], 0) );

	$model['config_webtsys']->forms['surveys']->SetParameters( array($config_data_copy['surveys'], $lang['common']['yes'], 1, $lang['common']['no'], 0) );

	$arr_index=array( $config_data_copy['index_page'] , $lang['config']['choose_page'], 0);
	...
	$model['config_webtsys']->forms['user_extra']->SetParameters( array( $config_data_copy['user_extra'], $lang['common']['yes'], 1, $lang['common']['no'], 0) );

	$model['config_webtsys']->forms['create_user']->SetParameters( array( $config_data_copy['create_user'], $lang['common']['yes'], 0, $lang['common']['no'], 1) );

	$arr_textbb_type=array( $config_data_copy['textbb_type'], $lang['config']['no_textbb'], '');
	...
	$arr_captcha_type=array( $config_data_copy['captcha_type'], $lang['config']['no_captcha'], '');
	...
	$arr_mailer_type=array( $config_data_copy['mailer_type'], $lang['config']['no_mailer'], '');
	...
	$admin->show_config_mode($config_data_copy);
